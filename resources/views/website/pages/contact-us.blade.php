                        ...
                        <div class="content">
                            ...
                            <div class="social">
                                ...
                                <div class="icons" dir="ltr">
                                    <div class="out-icon">
                                        <a href="{{$settings->fb_link}}"><img src="{{asset('websiteAssets/imgs/001-facebook.svg')}}"></a>
                                    </div>
                                    <div class="out-icon">
                                        <a href="{{$settings->tw_link}}"><img src="{{asset('websiteAssets/imgs/002-twitter.svg')}}"></a>
                                    </div>
                                    <div class="out-icon">
                                        <a href="{{$settings->youtube_link}}"><img src="{{asset('websiteAssets/imgs/003-youtube.svg')}}"></a>
                                    </div>
                                    <div class="out-icon">
                                        <a href="{{$settings->insta_link}}"><img src="{{asset('websiteAssets/imgs/004-instagram.svg')}}"></a>
                                    </div>
                                    <div class="out-icon">
                                        <a href="{{$settings->whatsapp_link}}"><img src="{{asset('websiteAssets/imgs/005-whatsapp.svg')}}"></a>
                                    </div>
                                    <div class="out-icon">
                                        <a href="{{$settings->google_link}}"><img src="{{asset('websiteAssets/imgs/006-google-plus.svg')}}"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
